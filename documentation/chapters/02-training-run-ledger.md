...
## Runs in the store (2 runs)

| # | run | started | parent | steps | envs | wall-clock | gates | distance p50 | falls | score | clip |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 1 | `20260907-135830-42943f`<br>r1-defaults-40M | 2026-09-07T20:58 | — | 40M | 2048 | 15.0 min | 13/14 | 1.13 m | 0.00 | 13.5 | [gif](media/rl-training/policy_r1-defaults-40M.gif) |
| 2 | `20260907-142153-d17a72`<br>r2-energy-fix-15M | 2026-09-07T21:21 | 20260907-135830-42943f | 15M | 2048 | 7.3 min | 13/14 | 1.19 m | 0.00 | 13.5 | [gif](media/rl-training/policy_r2-energy-fix-15M.gif) |
...
- **Gates:** 13/14; failing: energy_proxy (1.082 <= 1.0)
- **Reflection:** BENCHMARK FAILED 13/14 gates (score 13.50). Fell in 0/20 episodes. Median distance 1.13 m in 10.0 s. Velocity tracking RMSE 0.037 m/s. FAIL energy_proxy: 1.082 <= 1.0 W -> raise energy penalty 4 gates not evaluated (stage/group/metric).
...
- **Gates:** 13/14; failing: energy_proxy (1.394 <= 1.0)
- **Reflection:** BENCHMARK FAILED 13/14 gates (score 13.50). Fell in 0/20 episodes. Median distance 1.19 m in 10.0 s. Velocity tracking RMSE 0.040 m/s. FAIL energy_proxy: 1.394 <= 1.0 W -> raise energy penalty 4 gates not evaluated (stage/group/metric).
